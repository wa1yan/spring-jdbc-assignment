...
insert into project(name, description, manager, start, months) values ('Doctor Help', 'Clinick Management System', 2, '2022-05-01', 6);
insert into project(name, description, manager, start, months) values ('Order Me', 'Order Management System', 2, '2022-05-15', 18);
insert into project(name, description, manager, start, months) values ('The Movies', 'Movies Informations Provider', 3, '2022-04-10', 6);
